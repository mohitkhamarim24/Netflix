...
const AuthScreen = () => {
  ...
  return <div className="hero-bg relative">
    ...
    <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        <h2 className="text-4xl md:text-6xl font-bold mb-4">Unlimited movies,TV shows and more</h2>
        ...
        />
         <button className="bg-red-600 text-xl lg:text-2xl lg:px-6 py-1 md:py-2 rounded flex justify-center items-center">
        Get Started 
