    ...
    <div className="flex justify-center items-center mt-20 mx-3">
      ...
      <form className="space-y-4" onSubmit={handleSignup}>
        <div>
          ...
          <input type="email"
          className="w-full px-3 py-2 border border-gray-700 rounded-md bg-transparent text-white focus:outline-none
          focus:ring"
        ...
        <button className="w-full py-2 bg-red-600 text-white font-semiboldrounded-md
        hover:bg-red-700
        ">
          Sign Up
        </button>
